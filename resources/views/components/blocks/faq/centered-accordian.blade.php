<div class="bg-white">
    <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
        <div class="mx-auto max-w-4xl">
            <h2 class="text-4xl font-semibold tracking-tight text-neutral-900 sm:text-5xl">Frequently asked questions
            </h2>
                    ...
                    <div x-data="{ open: false }" class="py-6 first:pt-0 last:pb-0">
                        <dt>
                            <button type="button" x-description="Expand/collapse question button"
                                class="flex w-full items-start justify-between text-left text-neutral-900 cursor-pointer"
                        ...
                        <dd class="mt-2 pr-12" id="faq-0" x-show="open">
                            <p class="text-base/7 text-neutral-600">{!! $faq_item['answer'] !!}</p>
                        </dd>
                    </div>
                @endforeach
