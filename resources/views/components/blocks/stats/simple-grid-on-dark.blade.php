    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-none">
            <div class="text-center">
                ...
                <div class="mt-4 text-lg/8 text-gray-300">
                    {!! $data['content'] !!}
                </div>
            </div>
            <dl
                class="mt-16 grid grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 {{ count($data['stats']) > 3 ? 'lg:grid-cols-4' : 'lg:grid-cols-3' }}">
