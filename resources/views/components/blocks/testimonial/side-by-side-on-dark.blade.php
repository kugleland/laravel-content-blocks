                ...
                @php
                    $styleClasses =
                        $key % 2 == 0
                            ...
                            : 'border-t border-white/10 pt-10 sm:pt-16 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 xl:pl-20';
                @endphp
                ...
                <div class="flex flex-col {{ $styleClasses }}">
                    ...
                    <figure class="mt-10 flex flex-auto flex-col justify-between">
                        ...
                        <figcaption class="mt-10 flex items-center gap-x-6">
                            <img class="size-14 rounded-full bg-gray-800 object-cover object-center"
                                src="{{ Storage::url($testimonial['image']) }}" alt="">
                            <div class="text-base">
                                <div class="font-semibold text-white">{{ $testimonial['name'] }}</div>
                                <div class="mt-1 text-gray-400">{{ $testimonial['description'] }}</div>
                            </div>
                        </figcaption>
                    </figure>
                </div>
